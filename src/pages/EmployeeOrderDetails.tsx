  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-background to-background/90 pb-20">
        <MobileNavbar />
        <div className="container px-4 pt-6 pb-20 h-full flex items-center justify-center">
          <div className="text-center">
            <div className="w-12 h-12 rounded-full border-4 border-primary border-t-transparent animate-spin mx-auto"></div>
            <p className="mt-4 text-sm text-muted-foreground">Cargando detalles del pedido...</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-gradient-to-b from-background to-background/90 pb-20">
        ...
        <div className="container px-4 pt-6 pb-20">
          ...
          <div className="flex flex-col items-center justify-center h-64 text-center">
            ...
            <Button onClick={() => navigate('/employee')}>Ir al menú</Button>
          </div>
        </div>
      </div>
    );
        ...
        >
          ...
          <Card className="overflow-hidden mb-6">
              ...
              {lunch.image ? (
                ...
                <div className="flex items-center justify-center h-full">
                  <div className="h-16 w-16 rounded-full bg-primary/10 flex items-center justify-center">
                    <svg className="h-8 w-8 text-primary/50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <CardContent className="p-4">
              <h2 className="text-xl font-bold">{lunch.name}</h2>
              <p className="text-sm text-muted-foreground mt-2">{lunch.description}</p>
              
              <div className="mt-6 space-y-1">
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground">Precio:</span>
                  <span>${lunch.price.toFixed(2)}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground">Subsidio de empresa:</span>
                  <span className="text-green-600">- ${subsidyAmount.toFixed(2)}</span>
                </div>
                <div className="h-px bg-border my-2"></div>
                <div className="flex justify-between font-medium">
                  <span>Total a pagar:</span>
                  <span className="text-primary">${subsidizedPrice.toFixed(2)}</span>
                </div>
              </div>
