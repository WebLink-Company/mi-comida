    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-600 to-blue-800 relative overflow-hidden pb-24">
      ...
      <div className="container px-4 pt-6 pb-20 relative z-10">
        ...
        >
          ...
          >
            <Card className="overflow-hidden backdrop-blur-md bg-white/10 border border-white/20 shadow-xl">
              <div className="h-48 bg-primary/5 relative">
                {lunch.image ? (
                  ...
                  <div className="flex items-center justify-center h-full">
                    <div className="h-16 w-16 rounded-full bg-primary/10 flex items-center justify-center">
                      <svg className="h-8 w-8 text-white/40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="absolute top-4 right-4">
                  <Badge variant={getStatusColor(order.status) as any} className="flex items-center gap-1 bg-white/20 text-white backdrop-blur-md">
              ...
              <CardContent className="p-5">
                <h2 className="text-xl font-bold text-white">{lunch.name}</h2>
                <p className="text-sm text-white/70 mt-2">{lunch.description}</p>
                
                <div className="mt-6 space-y-1">
                  <div className="flex justify-between text-sm">
                    <span className="text-white/70">Precio:</span>
                    <span className="text-white">${lunch.price.toFixed(2)}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-white/70">Subsidio de empresa:</span>
                    <span className="text-green-300">- ${subsidyAmount.toFixed(2)}</span>
                  </div>
                  <div className="h-px bg-white/20 my-2"></div>
                  <div className="flex justify-between font-medium">
                    <span className="text-white">Total a pagar:</span>
                    <span className="text-white text-lg">${subsidizedPrice.toFixed(2)}</span>
                  </div>
                </div>
